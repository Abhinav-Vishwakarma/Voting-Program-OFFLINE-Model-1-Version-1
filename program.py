...
Do you want to overwrite?'''
                ...
                def change3(self):
                        ...
                        select_pos=List
                        if len(List)!=0:
                                #select_post1=tk.OptionMenu(f9,var4,*select_post)
                                x=var4.get()
                                ...
                                select_post1.destroy()
                                post_list2=show()
                                select_post37=post_list2
                                select_post1=tk.OptionMenu(f9,var4,*select_post37,command=change3)
                                select_post1.config(width=20,height=2)
                                select_post1.place(x=700,y=100)
                        else:
                                select_post1.destroy()
                                select_post1=tk.OptionMenu(f9,var4,value="")
                                select_post1.config(width=20,height=2)
                                select_post1.place(x=700,y=100)
                                heading56.config(text="No Data Found!")
                                table3.delete(*table3.get_children())
                                table3.insert(parent='',index=0,iid=0,text='',values=("No Data found!","Error!"))
                                lab.config(text="Total Votes Count 0")
...
#---------------------------------other post-----------------------------------------------------------------------------------------
 ...
 # -----------------other post result window-----------------------------------------------------
                ...
                if len(post_list2)==0:
                        ...
                        select_post1.config(width=20,height=2)
                        select_post1.place(x=700,y=100)
                        heading56=tk.Label(result_frame,text="No Data Found!",font=('Arial Black',13),bg="Purple",fg="White")
                        heading56.place(x=0,y=0,relwidth=1)
                else:
                        var4.set(select_post36[0])
                        select_post1=tk.OptionMenu(f9,var4,*select_post36,command=change3)
                        select_post1.config(width=20,height=2)
                        select_post1.place(x=700,y=100)
                        heading56=tk.Label(result_frame,text="Results for post of {}".format(select_post36[0]),font=('Arial Black',13),bg="Purple",fg="White")
                        heading56.place(x=0,y=0,relwidth=1)
